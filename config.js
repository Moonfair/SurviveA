...
const EVENT_LIST = [
    ...
    },
    {
        ...
        desc:"你看到同事猝死的工位", 
        options:[
            {text:"请假休息",effect:{job:-10, spirit:+10}, resultText: "你实在顶不住了，决定请假休息一天。至于堆积的工作、同事的挤兑、老板的不满......你都无暇顾及了。你只想好好睡一觉。"},
            {text:"使用强化剂",effect:{spirit:+10, job:+5, money:-1000}, resultText: "你敏锐的察觉到老板的不满——他并不是真的希望你休息，而是在暗暗敲打你的工作状态。你知道再不做出些改变，你可能会永远失去这份薪水并不丰厚的工作。你来到楼下的便利店忍痛买了根强化剂。喝下的瞬间，你一下摆脱了疲劳，也失去了些别的什么东西......"},
            {text:"强撑",effect:{spirit:-15, job:-5}, resultText: "你不敢请假，也不想成为天天依靠强化剂的毒狗，只能咬咬牙强撑下去。即使如此，你还是错漏百出，不得不花加倍的时间来完成工作。终于，在凌晨3点钟，你拖着疲惫的身躯走出了空无一人的办公室。"},
        ]
    },
...
// ===================== 结局配置 =====================
// resultType: "special" = 特殊结局（立即触发），"normal" = 普通结局（回合结束时随机）
// type: "HE" = 好结局，"BE" = 坏结局
const RESULT_LIST = [
    // 特殊结局：黑诊所死亡
    {id:22, resultType:"special", type:"BE", title:"化身高达", desc:"你顺利在黑诊所约到了一台手术，安心地打上麻药，在无影灯下躺下。但你再也没有睁开眼睛。你的器官将帮助其他人更好的活下去。", condition:(gs)=>gs.customFlag.blackClinic},

    // 死亡结局：心衰
    {id:1, resultType:"special", type:"BE", title:"钢铁丛林", desc:"你感到一阵天旋地转。有时候在城市的钢铁丛林里生存，并不比荒野中容易。现在你终于能休息了。",condition:(gs)=>gs.currentStatus.spirit <= 0},
